package com.example.rxandroidmvp.databaseHelper;
...
public class MyLocalDb extends SQLiteOpenHelper {
    ...
    public ArrayList<NewsModel.Row> getNewsList(Context context){

        ArrayList<NewsModel.Row> newslist=new ArrayList<>();
